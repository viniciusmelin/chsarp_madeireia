USE [master]
GO
/****** Object:  Database [ESMPLUS]    Script Date: 21/08/2016 23:04:52 ******/
...
USE [ESMPLUS]
GO
/****** Object:  Table [dbo].[tblCliente]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblContasReceber]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblContasReceberSituacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblEMail]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblEndereço]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblEstoque]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblFornecedor]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblOperacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblOperacaoSituacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblPedido]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblPedidoItem]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblPedidoTipo]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblPessoa]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblProduto]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblSituacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblTelefone]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblTipoPagamento]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblUsuario]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblVendedor]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[tblEndereço] ADD  DEFAULT (NULL) FOR [Complemento]
GO
...
GO
ALTER TABLE [dbo].[tblEndereço]  WITH CHECK ADD  CONSTRAINT [FK_TBLENDERECOIDPESSOA] FOREIGN KEY([IDPessoa])
REFERENCES [dbo].[tblPessoa] ([IDPessoa])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[tblEndereço] CHECK CONSTRAINT [FK_TBLENDERECOIDPESSOA]
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarCliente]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	BEGIN TRY
		BEGIN TRAN
			...
			ELSE IF(@INintAcao = 1)
			BEGIN
				EXEC @INintIDPessoaCliente = uspCadastrarPessoa 
				@INintAcao = @INintAcao,
				@INintIDPessoa = NULL,
				@INvchNome = @INvchNome,
				@INdecCpfCnpj = @INdecCpfCnpj,
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarContasReceber]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarEmail]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarEndereco]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarOperacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarPedido]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarPedidoItem]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarPedidoSituacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarPessoa]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	IF(@INintAcao = 0)
	BEGIN
		IF(NOT EXISTS(SELECT CpfCnpj FROM tblPessoa WITH(NOLOCK) WHERE CpfCnpj = @INdecCpfCnpj))
		BEGIN
	...
	ELSE IF(@INintAcao = 1)
	BEGIN
	IF(NOT EXISTS(SELECT * FROM tblPessoa WITH(NOLOCK) WHERE CpfCnpj = @INdecCpfCnpj))
	BEGIN
		UPDATE
			tblPessoa
		SET
	...
	BEGIN
		...
		END
	END
		SELECT @INintIDPessoa AS Retorno
	END
...
END
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarProduto]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarSituacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarSituacaoOperacao]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspCadastrarTipoPagamento]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[uspPesquisarCliente]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[uspPesquisarEmailCliente]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[uspPesquisarEmailCliente]
@INIDPessoa INT
AS
BEGIN
	SET NOCOUNT ON
...
END
GO
/****** Object:  StoredProcedure [dbo].[uspUsuarioAcesso]    Script Date: 21/08/2016 23:04:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
